    ...
    <div class="header">
      ...
      <div class="header-right">
        <div class="action-buttons">
          <button class="icon-button" @click="clearChat" title="清空对话">
      ...
      <div class="messages-container" ref="messagesContainer">
        ...
        <div v-if="messages.length === 1" class="welcome-section">
          <div class="welcome-card">
            ...
            <h3>AI 图像分析助手</h3>
            <p>我可以帮助您分析图像风格、颜色、构图等视觉元素，并提供专业的设计建议和创意灵感。</p>
            <div class="quick-actions">
              <button class="quick-action" @click="addQuickMessage('分析图像构图')">
                <span>📐</span> 分析构图
              </button>
              <button class="quick-action" @click="addQuickMessage('提取配色方案')">
                <span>🎨</span> 配色分析
              </button>
              <button class="quick-action" @click="addQuickMessage('设计建议')">
                <span>💡</span> 设计建议
              </button>
            </div>
          </div>
          ...
          <div class="message-content">
            ...
            <div class="message-bubble">
              ...
              <div v-if="message.type === 'ai-loading'" class="typing-indicator">
                ...
                <span class="typing-text">正在执行...</span>
              </div>
...
const processMessageWithFiles = async (content, type = 'ai-message') => {
  ...
  if (content.includes('任务结束')) {
    fileLinks = extractFileLinks(content);
  }
...
const clearChat = () => {
  if (confirm('确定要清空所有对话吗？')) {
    ...
    // 添加欢迎消息
    addMessage('欢迎使用YooPic 智能体！我可以帮助您分析图像风格、颜色、构图等视觉元素，并提供专业的设计建议和创意灵感。请上传一张图片进行分析，或告诉我您的设计需求。', false)
  }
}
